...
public class PollService extends IntentService {
    ...
    public static final String ACTION_SHOW_NOTIFICATION = "com.ckt.cc.photogallery" + "" + "" +
            ".SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "com.ckt.cc.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (!isNetworkAvialableAndConnected()) {
            return;
        }
    ...
    private boolean isNetworkAvialableAndConnected() {
